...
echo 공문서 작성 퀴즈를 여는 중입니다...
if not defined SKIP_BROWSER start "" /b powershell.exe -NoProfile -WindowStyle Hidden -Command "Start-Sleep -Milliseconds 900; Start-Process 'http://127.0.0.1:4175'"
echo.
